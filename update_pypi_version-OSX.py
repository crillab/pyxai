...
print("sudo rm -rf build/ dist/ wheelhouse/ rm -rf dist/ build/ pyxai-experimental.egg-info/")

os.system("sudo rm -rf build/ dist/ wheelhouse/ rm -rf dist/ build/ pyxai-experimental.egg-info/")
...
os.system("sudo docker run --rm -e PLAT=manylinux2014_aarch64 -v `pwd`:/io quay.io/pypa/manylinux2014_aarch64 /io/travis/build-wheels.sh")

print("Type Enter to execute the publish on pypi the wheels:")
input()
os.system("python3 -m twine upload --skip-existing wheelhouse/*")
