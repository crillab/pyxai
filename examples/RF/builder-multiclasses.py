...
node_1_1 = Builder.DecisionNode(2, operator=Builder.EQ, threshold=1, left=3, right=2)
node_1_2 = Builder.DecisionNode(3, operator=Builder.EQ, threshold=1, left=4, right=node_1_1)
node_1_3 = Builder.DecisionNode(5, operator=Builder.EQ, threshold=1, left=1, right=node_1_2)
...
node_2_1 = Builder.DecisionNode(5, operator=Builder.EQ, threshold=1, left=1, right=2)
node_2_2 = Builder.DecisionNode(2, operator=Builder.EQ, threshold=1, left=3, right=node_2_1)
...
node_3_3 = Builder.DecisionNode(6, operator=Builder.EQ, threshold=1, left=2, right=node_3_2)
node_3_4 = Builder.DecisionNode(2, operator=Builder.EQ, threshold=1, left=node_3_1, right=node_3_3)
tree_3 = Builder.DecisionTree(6, node_3_4)

node_4_1 = Builder.DecisionNode(4, operator=Builder.EQ, threshold=1, left=4, right=3)
tree_4 = Builder.DecisionTree(6, node_4_1)

node_5_1 = Builder.DecisionNode(3, operator=Builder.EQ, threshold=1, left=2, right=4)
node_5_2 = Builder.DecisionNode(2, operator=Builder.EQ, threshold=1, left=3, right=node_5_1)
