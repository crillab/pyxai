...
setup(name='pyxai',
      ...
      install_requires=['lxml', 'numpy', 'wheel', 'pandas', 'termcolor', 'shap', 'wordfreq', 'python-sat[pblib,aiger]', 'xgboost==1.7.3', 'pycsp3', 'matplotlib', 'pyqt6', 'dill', 'lightgbm', 'docplex', 'ortools'],
