# dataset source: http://www.timeseriesclassification.com/description.php?Dataset=Wine

from pyxai import Learning, Explainer, Tools

import pandas

data = pandas.read_csv(Tools.Options.dataset, names=["V"+str(i) for i in range(1,235)]+["label"], sep=',') 
